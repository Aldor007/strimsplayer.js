...
var StrimsAPI = function (url, filtr) {
...
StrimsAPI.prototype.getContentOfArrayOfStrims = function(strims, callback) {
    ...
    var crawler = new Crawler({
        ...
        'onDrain': function() {
            callback(crawlerErr. contentList);
        },
...
StrimsAPI.prototype._parseContent = function(content, $, callback) {
    ...
    data.downvotes =   jquery.find(StrimsAPI.CRAWLER.DOWNVOTES).text();
...
StrimsAPI.CRAWLER.DOWNVOTES = 'a.dislike>span.content_vote_count';
