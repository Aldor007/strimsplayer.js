 ...
 */
var DateUtils = {};
DateUtils.dateFromString = (function () {
...
DateUtils.parseDate = function(indate) {

  var months = ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG",
      "SEP", "OCT", "NOV", "DEC"];
    indate = indate.replace('stycznia', 'JAN');
    indate = indate.replace('lutego', 'FEB');
    indate = indate.replace('marca', 'MAR');
    indate = indate.replace('kwietnia', 'APR');
    indate = indate.replace('maja',  'MAY');
    indate = indate.replace('czerwca', 'JUN');
    indate = indate.replace('lipca', 'JUL');
    indate = indate.replace('sierpnia', 'AUG');
    indate = indate.replace('września', 'SEP');
    indate = indate.replace('pażdziernika', 'OCT');
    indate = indate.replace('listopda', 'NOV');
    indate = indate.replace('grudnia', 'DEC');
